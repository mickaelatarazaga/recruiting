...
public class CandidateControllerImp implements CandidateController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "202", description = "The Candidate DNI number already exist", content = @Content)
    })
    @PostMapping("/add")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "202", description = "Candidate not found", content = @Content)
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successfully updated Candidate", content = @Content),
            @ApiResponse(responseCode = "202", description = "Candidate not found", content = @Content)
    })
    @PutMapping("/{id}")
